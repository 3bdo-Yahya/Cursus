...
| Also in progress | MA222, IS211, CS242, PH201 |
...
| Direct dependents | AI301, CS311, CS312, CS331, IS313, IT473 | curriculum prereqs |
| **Blocked courses (transitive)** | **20** | BFS over prereq graph |
| **Credits at risk** | **60** | sum of blocked course credits |
...
Blocked codes (locked list for on-panel / WebGL labels):
...
- [ ] Blocked count matches **20** (or note delta and update this file + WebGL panels)
- [ ] Credits at risk ≈ **60**
...
From `curriculum-courses.json`, BFS from `CS211` over reverse prerequisite edges → blocked count + credit sum. Figures locked 2026-07-14.
